...
class DefaultTransformedVariantFactoryTest extends Specification {
    ...
    private ComponentIdentifier component(String group, String module) {
        DefaultModuleComponentIdentifier.newId(DefaultModuleIdentifier.newId(group, module), "1.0")
    }

    private VariantResolveMetadata.Identifier id(String name) {
    ...
    private ImmutableAttributes attributes(String name, String value) {
    ...
    private TransformChain chain(TransformStep step) {
    ...
    private ResolvedArtifactSet artifactSet(ResolvableArtifact... artifacts) {
